...
> **Note:** Useful when the `HTTPOnly` flag is **not** set on the session cookie.
...
| Source | Name |
|---|---|
| Immersive Labs | Hack Your First Web App |
