...
|---|---|---|
| `SantaSwipe.apk` | Challenge APK | HHC 2024 Act II - Mobile Analysis |
| `SantaSwipeSecure.aab` | Hardened version (AAB format) | HHC 2024 Act II - Mobile Analysis |
| `universal.apk` | Universal APK extracted from AAB | HHC 2024 Act II - Mobile Analysis |
| `decrypt_data.py` | Decryption script using key recovered from app | HHC 2024 Act II - Mobile Analysis |
| `src/` | Decompiled Kotlin source (DatabaseHelper, MainActivity) | HHC 2024 Act II - Mobile Analysis |
| `resources/res/values/strings.xml` | App string resources (may contain hardcoded keys) | HHC 2024 Act II - Mobile Analysis |
...
- [HackTricks - Android APK Checklist](https://book.hacktricks.xyz/mobile-pentesting/android-app-pentesting/android-apk-decompilation)
