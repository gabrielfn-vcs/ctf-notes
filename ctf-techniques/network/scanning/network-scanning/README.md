...
> **Note:** Network scanning without explicit permission is illegal in most jurisdictions. Always ensure you have authorisation before scanning any network.
...
Netcat can also be used for banner grabbing, data transfer between hosts, and connecting to remote shells. See [`../banner-grabbing/`](../banner-grabbing/) for banner grabbing usage.
...
- [HackTricks - Network Scanning](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network)
