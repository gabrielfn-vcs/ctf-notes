...
Zone transfers use TCP (Transmission Control Protocol), but where this is disabled, it is often possible to brute force addresses by using a wordlist of host names and submitting many queries to the server. See [`../dns-zone-transfer/`](../dns-zone-transfer/) for a full walkthrough and example output.
...
- [PayloadsAllTheThings - DNS Rebinding](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/DNS%20Rebinding)
