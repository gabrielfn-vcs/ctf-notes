...
- [CTF Techniques](#ctf-techniques)
  ...
  - [Structure](#structure)
  - [Sources](#sources)
  - [Getting a macOS system ready for playing CTFs](#getting-a-macos-system-ready-for-playing-ctfs)
...
A personal reference repository of techniques, tools, and scripts collected from CTF (Capture The Flag) competitions and security labs.
...
| 🔌 [`hardware/`](./hardware/README.md) | Hardware | Hardware protocol capture and decoding — 1-Wire, I²C, SPI, CAN bus |

---

## Sources

Techniques here were extracted and generalized from the following events/platforms:

- [CTFd](../ctf-writeups/ctfd/)
- [SANS Holiday Hack Challenge](../ctf-writeups/holiday-hack-challenge/)
- [Immersive Labs](../ctf-writeups/immersive-labs/)
...
In order to install Homebrew we have to install the latest Xcode Command Line Tools xcode `commandline-tools` so let's do this:
...
Additionally, we need Python 3, Pip, Pipx, Wget, OpenSSL and Git.
...
If you don't want/need multicore and want the main binary and extra utilities, go for:
```bash
