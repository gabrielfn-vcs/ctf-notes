...
|---|---|---|
| `FreeSki.exe` | PyInstaller-compiled Python executable | HHC 2025 Act III - Free Ski |
| `FreeSki.pyasm` | Disassembled Python bytecode | HHC 2025 Act III - Free Ski |
| `FreeSki-deepseek.py` | Reconstructed Python source | HHC 2025 Act III - Free Ski |
| `pyinstxtractor.py` | Tool to unpack PyInstaller executables | HHC 2025 Act III - Free Ski |
| `get_flag.py` | Script to extract flag from unpacked binary | HHC 2025 Act III - Free Ski |
| `gnome_cancontroller` | Go Linux ELF binary recovered from server via `/proc` | HHC 2025 Act III - Hack-a-Gnome |
| `TCUP.class` / `TCUP.java` | Java challenge bytecode and source | IL-01 Lab 7 - Teacup Trouble |
| `confusing-code.asm` / `confusing-code.c` | Assembly and C source for analysis | IL-02 Lab 5 - Confusing Code |
| `main.bcde0d62.js` | Obfuscated JavaScript for analysis | IL-02 Lab 3 - Delving Deeper |
...
javap -c -p Target.class         # bytecode
procyon Target.class             # readable Java
cfr Target.class                 # alternative decompiler
```
