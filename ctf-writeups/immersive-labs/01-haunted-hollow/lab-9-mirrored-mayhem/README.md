...
- [Lab 9 - Mirrored Mayhem](#lab-9---mirrored-mayhem)
  ...
  - [RCE Vulnerability](#rce-vulnerability)
...
Meanwhile, on the client side, we will run this comamnd to receive the commands outputs:
```bash
$ sudo nc -nlvp 4444
```
```
...
To grab all the files under `/opt/app`
