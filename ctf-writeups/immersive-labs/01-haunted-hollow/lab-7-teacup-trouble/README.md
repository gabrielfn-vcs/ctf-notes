...
This lab provides a Java compiled class that runs an application that expects a series of emojis in the right order as an input to solve the challenge.

## Analysis

### Reverse Engineering
The first step is to decompile and analyze the given [`TCUP.class`](./TCUP.class) file to analyze the functionality.
...
* Need to make sure all the Unicode points are included for those during the input.
...
This are the steps of the core algorithm:
