...
- [Hardware Part I](#hardware-part-i)
  ...
  - [Hints](#hints)
    - [Hint 1: On the Cutting Edge](#hint-1-on-the-cutting-edge)
    - [Hint 2: Shredded to Pieces](#hint-2-shredded-to-pieces)
  - [Recon](#recon)
  - [Silver](#silver)
...
To the right of the center of the yard stands Jewel Loggins next to two terminals.
...
> [!NOTE]
> The `requestID` value is session-specific.
...
| File | Description |
|---|---|
| [`heuristic_edge_detection.py`](./heuristic_edge_detection.py) | Script to reassemble shredded image slices by matching edge pixel values |
| [`shreds.zip`](./shreds.zip) | Archive containing 1,000 shredded image slices |
| [`assembled_image.png`](./assembled_image.png) | Reconstructed image output from the script |
