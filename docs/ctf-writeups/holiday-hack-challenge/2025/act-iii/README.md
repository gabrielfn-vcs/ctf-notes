...
| [`on-the-wire/`](./on-the-wire/README.md) | Hardware — 1-Wire, SPI, I2C protocol decoding with XOR decryption |
...
- [`ctf-techniques/hardware/`](../../../../ctf-techniques/hardware/README.md) — 1-Wire, SPI, and I2C protocol capture and decoding
