...
.rwx------  1   36 ctfuser  2 Mar 16:50 │   └── fseventsd-uuid*
...
.rwx------  1   69 ctfuser 18 Mar  2025     └── QB.INI*
```
...
| File | Description |
|---|---|
| [`floppy.img`](./floppy.img) | FAT12 floppy disk image containing the Quick Basic environment and a deleted Star Trek BASIC program |
| [`all_i-want_for_christmas.bas`](./all_i-want_for_christmas.bas) | Deleted BASIC file recovered from the disk image containing the hidden Base64 message |
