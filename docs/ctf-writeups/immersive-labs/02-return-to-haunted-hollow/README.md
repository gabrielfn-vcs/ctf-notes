...
![il-list.png](./il-list.png)

---

## All Challenges

### Lab 1: [Phishing for Treats - Halloween Edition](./lab-1-phishing-for-treats/README.md)
Who did Count Dracula intend to send the love letter to? `Morticia`

### Lab 2: [PCAP Pandemonium](./lab-2-pcap-pandemonium/README.md)
...
### Lab 3: [Delving Deeper](./lab-3-delving-deeper/README.md)
...
### Lab 4: [Encryption Enigma](./lab-4-encryption-enigma/README.md)
...
### Lab 5: [Confusing Code](./lab-5-confusing-code/README.md)
What is the password to the computer? `pge2j`

Make a note of this, you'll need it for the final lab.

### Lab 6: [Haunted Helpdesk](./lab-6-haunted-helpdesk/README.md)
...
### Lab 7: [Fearsome Forensics](./lab-7-fearsome-forensics/README.md)
What is the social media handle of the AI's creator? `HHfredAI`

You should make a note of the answer to this question, as you'll need it to escape through the Emergency Exit.

### Lab 8: [Spooky, Scary, Silly Snaps](./lab-8-spooky-scary-silly-snaps/README.md)
