...
- [Lab 4 - Encryption Enigma](#lab-4---encryption-enigma)
  ...
  - [Maniacal Mirror](#maniacal-mirror)
    - [Encoded Message 1](#encoded-message-1)
    - [Decoded Message 1](#decoded-message-1)
  - [Revengful Reflection](#revengful-reflection)
    - [Encoded Message 2](#encoded-message-2)
    - [Decoded Message 2](#decoded-message-2)
  - [Phantom Portal](#phantom-portal)
    - [Encoded Message 3](#encoded-message-3)
    - [Decoded Message 3](#decoded-message-3)
  - [Analysis](#analysis)
  - [Solution](#solution)
...
2. **Revengeful Reflection:**
   - Base64 message.
   - Says **Phantom Portal** message is not hexadecimal.
...
| | |
|:---|---:|
| ← [Delving Deeper](../lab-3-delving-deeper/README.md) | [Confusing Code](../lab-5-confusing-code/README.md) → |
