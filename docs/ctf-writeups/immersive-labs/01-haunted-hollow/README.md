...
- [Haunted Hollow](#haunted-hollow)
  ...
  - [All Challenges](#all-challenges)
    ...
    - [Lab 10: One Last Ride](#lab-10-one-last-ride)
...
![Halloween: The Haunted Hollow Part 1](./il-list.png)

---

## All Challenges

### Lab 1: [The Gatekeepers](./lab-1-the-gatekeepers/README.md)
- **QR Code 1:** Creeping through the code, under the moon's glow,
- **QR Code 2:** On this eerie Halloween night, the cyber winds blow,
- **QR Code 3:** Riddles and mysteries, in the Labs they stow.
- **QR Code 4:** Whispering secrets only Immersive Labs know.
- **Word:** CROW

### Lab 2: [Python Pit](./lab-2-python-pit/README.md)
```html
<!-- If you want to shut this pit down for good and get out of this place, you'll need this code - OuroborosAreWheels -->
```

### Lab 3: [The Cursed Crypt](./lab-3-the-cursed-crypt/README.md)
- **First Riddle:** `GHOST`
- **Second Riddle:** `SPECTER`
    - To run the rollercoaster in the final lab of this challenge, you'll need some magic potions to fuel it up. What is the answer to the third riddle? (Take a note of it! You'll also need it as a code in the final lab of the collection.)
- **Third Riddle:** `WITCHESBREW`
- **Fourth Riddle:** `PUMPKIN`

### Lab 4: [Escape from jAWS!](./lab-4-escape-from-jaws/README.md)
...
### Lab 5: [Carnival Chaos](./lab-5-carnival-chaos/README.md)
...
### Lab 6: [Rusty Rollercoaster](./lab-6-rusty-rollercoaster/README.md)
```
...
### Lab 7: [Teacup Trouble](./lab-7-teacup-trouble/README.md)
- **Token:** `a576e7`
...
### Lab 8: [Haywire Host](./lab-8-haywire-host/README.md)
```
...
### Lab 9: [Mirrored Mayhem](./lab-9-mirrored-mayhem/README.md)
