...
- [Lab 8 - Haywire Host](#lab-8---haywire-host)
  ...
  - [Challenges](#challenges)
    - [1: Find environment variable](#1-find-environment-variable)
    - [2: Find file under `/tmp`](#2-find-file-under-tmp)
    - [3: Get strings from binary file in `/opt` and find one related to coconuts](#3-get-strings-from-binary-file-in-opt-and-find-one-related-to-coconuts)
    - [4: Listen to server running on port 1337](#4-listen-to-server-running-on-port-1337)
    - [5: Kill a process that changes name every second and get secret value from a file in `/tmp` after killing it](#5-kill-a-process-that-changes-name-every-second-and-get-secret-value-from-a-file-in-tmp-after-killing-it)
  - [Solution](#solution)
    - [Answer](#answer)
...
| | |
|:---|---:|
| ← [Teacup Trouble](../lab-7-teacup-trouble/README.md) | [Mirrored Mayhem](../lab-9-mirrored-mayhem/README.md) → |
