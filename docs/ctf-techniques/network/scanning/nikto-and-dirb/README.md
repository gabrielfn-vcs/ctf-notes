...
- [Nikto and DIRB](#nikto-and-dirb)
  ...
  - [Overview](#overview)
  - [Nikto](#nikto)
    - [Nikto Usage](#nikto-usage)
    - [Nikto Example Output](#nikto-example-output)
  - [DIRB](#dirb)
    - [DIRB Usage](#dirb-usage)
    - [DIRB Example Output](#dirb-example-output)
...
> [!NOTE]
> Nikto is not stealthy. Its behavior is easily detected in IDS logs. This also makes it useful for testing whether an IDS solution is generating false positives.
